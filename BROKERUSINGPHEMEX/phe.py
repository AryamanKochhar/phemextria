...
class Client(object):
    ...
    def __init__(self, api_key=None, api_secret=None, is_testnet=False):
        self.api_key = '34f3acce-92a9-4bfd-a692-d4d80041c371'
        self.api_secret ='PEvPJ5IPvLnlqVc0qgjsnZ6e8sNyGrKMtAdMXip3c4RlOGM1MTRlNS04NzJhLTQzYTYtYTBiYS1hZDJjZWVmOGZjMTk'
